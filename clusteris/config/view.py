...
class ConfigView (wx.Dialog):
    ...
    def BuildMainUI(self, parent):
        wx.Frame.__init__(self, parent, id = wx.ID_ANY, title = u"Configuración de procesamiento", pos = wx.DefaultPosition, size = wx.Size(-1,-1), style = wx.CAPTION|wx.CLOSE_BOX|wx.MAXIMIZE_BOX|wx.MINIMIZE_BOX|wx.SYSTEM_MENU|wx.TAB_TRAVERSAL)
